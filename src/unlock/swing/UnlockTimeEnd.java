...
public final class UnlockTimeEnd extends JFrame {

    private static UnlockMusicPlayer player;

    private static Thread music;

    public UnlockTimeEnd(boolean song) {
    ...
    public void initComponents(boolean song) {
        ...
        JLabel timing = new JLabel("Le temps est écoulé !");
        timing.setHorizontalAlignment(SwingConstants.CENTER);
        timing.setFont(UnlockFont.setFont("Century Schoolbook", Font.BOLD, 14));
