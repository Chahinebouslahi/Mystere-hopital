...
public final class UnlockGoodEnd extends JFrame {

    private static UnlockMusicPlayer player;

    private static Thread music;

    public UnlockGoodEnd(boolean song) {
    ...
    public void initComponents(boolean song) {
        ...
        if (song) {
            player = new UnlockMusicPlayer("src" + java.io.File.separator + "unlock" + java.io.File.separator + "sons" + java.io.File.separator + "win.mp3");
        ...
        JLabel subtitle = new JLabel("Vous avez gagné !!!");
        subtitle.setHorizontalAlignment(SwingConstants.CENTER);
        subtitle.setFont(UnlockFont.getSubtitleFont());

        JLabel fin = new JLabel("Vous avez réussi à vous échapper !");
